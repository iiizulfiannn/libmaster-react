    ...
    render() {
        ...
        return (
            <Navbar
                expand="md"
                fixed="top"
                className="navbar-dark bg-dark shadow p-3 mb-5"
            >
                <NavbarBrand
                    tag={Link}
                    to="/"
                ...
                <Collapse
                    ...
                    className="collapse-custom justify-content-lg-between justify-content-md-between justify-content-xl-between"
                    navbar
                >
